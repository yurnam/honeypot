...
ssh $SERVER << EOF
  ...
  sudo docker run -d --name $APP_NAME -p 80:80 -p 2222:2222 -p 21:21 -p 25:25 -p 443:443 -p 3306:3306 -p 9100:9100 -p 5060:5060/udp -p 3389 --restart unless-stopped $IMAGE_NAME
