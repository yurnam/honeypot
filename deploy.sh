...
ssh $SERVER << EOF
  ...
  sudo docker run -d --name $APP_NAME -p 80:80 -p 2222:2222 -p 21:21 -p 25:25 -p 443:443 -p 143:143 -p 587:587 -p 465:465 -p 3306:3306 -p 9100:9100 -p 1883:1883 -p 5060:5060/udp -p 161:161/udp -p 3389:3389 -p 5900:5900 -p 23:23 --restart unless-stopped $IMAGE_NAME
